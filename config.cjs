...
const config = {
  SESSION_ID: process.env.SESSION_ID || "JOEL-XMD~dEww3YTJ#jAcDAuwIJmkdsm0iZIY0lvP5QbikPdgfmylLIjwi2Iw",
...
// don't use my codes without a permission 🙏
  ...
  OWNER_NAME: process.env.OWNER_NAME || "D4SHIE",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "27822972411",
